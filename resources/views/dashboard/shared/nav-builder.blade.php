...
if(!function_exists('renderDropdown')){
    function renderDropdown($data){
        if(array_key_exists('slug', $data) && $data['slug'] === 'dropdown'){
            ...
            echo '<a class="c-sidebar-nav-dropdown-toggle" href="javascript:void(0)">';
...
?>
        ...
        <div class="c-sidebar-brand">
            <img class="c-sidebar-brand-full" src="{{ url('/assets/img/site/logo.png') }}" width="46" height="46" alt="Iscents Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('/assets/img/site/logo.png') }}" width="46" height="46" alt="Iscents Logo">
        </div>
